...
pub const _INVALID_INSTRUCTION: &str = "Invalid instruction length";
...
pub const INVALID_ACCOUNT_ID: &str = "Invalid account id";
pub const VALUE_EXCEEDED: &str = "the total balance greater than max value allowed";
