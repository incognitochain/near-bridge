...
pub const GAS_FOR_RESOLVE_DEPOSIT_SWAP_WITHDRAW: Gas = Gas(196_000_000_000_000);

pub const GAS_FOR_DEPOSIT_BRIDGE: Gas = Gas(52_000_000_000_000);
pub const GAS_FOR_DEPOSIT_REF: Gas = Gas(35_000_000_000_000);
pub const PADDING_GAS: Gas = Gas(15_000_000_000_000);