...
pub const BRIDGE_CONTRACT: &str = "bridge.incognito_chain.testnet";
...
pub const GAS_FOR_RESOLVE_DEPOSIT_REF_FINANCE: Gas = Gas(160_000_000_000_000);
pub const GAS_FOR_SWAP_REF_FINANCE: Gas = Gas(40_000_000_000_000);
pub const GAS_FOR_RESOLVE_SWAP_REF_FINANCE: Gas = Gas(90_000_000_000_000);
...
pub const GAS_FOR_DEPOSIT: Gas = Gas(100_000_000_000_000);
